export type RANKS_TYPE = {
  name: string
  uri: string
}

export const RANKS = new Map<string, {name: string, uri: string}>(
[
  ["OR2", {
    "name": "Sotamies",
  ...
  ["OR4", {
    "name": "Alikersantti",
    "uri": "/ranks/or/OR4.svg"
  }],
  ["OR5", {
    "name": "Kersantti",
    "uri": "/ranks/or/OR5.svg"
  }],
  ["OR6", {
    "name": "Ylikersantti",
    "uri": "/ranks/or/OR6.svg"
  }],
  ["OR7", {
    "name": "Vääpeli",
    "uri": "/ranks/or/OR7.svg"
  }],
  ["OR8", {
    "name": "Ylivääpeli",
    "uri": "/ranks/or/OR8.svg"
  }],
  ["OR9", {
    "name": "Sotilasmestari",
    "uri": "/ranks/or/OR9.svg"
  }],
  ["OFS", {
    "name" : "Upseerioppilas",
